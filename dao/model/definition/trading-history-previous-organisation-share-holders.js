...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('TradingHistoryPreviousOrganisationShareHolder', {
        creditReportID: {
        ...
        schema: 'public',
        tableName: 'TradingHistoryPreviousOrganisationShareHolders',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    TradingHistoryPreviousOrganisationShareHolder.belongsTo(CreditReport, {
        as: 'CreditReport',
