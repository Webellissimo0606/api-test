...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('TradingHistoryOtherOrganisationOfficer', {
        creditReportID: {
        ...
        schema: 'public',
        tableName: 'TradingHistoryOtherOrganisationOfficers',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    TradingHistoryOtherOrganisationOfficer.belongsTo(CreditReport, {
        as: 'CreditReport',
