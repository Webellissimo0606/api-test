...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('TradingHistoryPreviousSecretary', {
        creditReportID: {
        ...
        schema: 'public',
        tableName: 'TradingHistoryPreviousSecretaries',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    TradingHistoryPreviousSecretary.belongsTo(CreditReport, {
        as: 'CreditReport',
