...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('TradingHistoryPreviousIndividualShareHolder', {
        creditReportID: {
        ...
        schema: 'public',
        tableName: 'TradingHistoryPreviousIndividualShareHolders',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    TradingHistoryPreviousIndividualShareHolder.belongsTo(CreditReport, {
        as: 'CreditReport',
