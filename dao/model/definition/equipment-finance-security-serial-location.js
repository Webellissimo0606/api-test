...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('EquipmentFinanceSecuritySerialLocation', {
        iD: {
        ...
        schema: 'public',
        tableName: 'EquipmentFinanceSecuritySerialLocation',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    EquipmentFinanceSecuritySerialLocation.belongsTo(ApplicationSecurity, {
    ...
    EquipmentFinanceSecuritySerialLocation.belongsTo(PartyRole, {
    ...
    EquipmentFinanceSecuritySerialLocation.belongsTo(PremisesLocationType, {
