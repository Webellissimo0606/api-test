...
module.exports = function(sequelize, DataTypes) {
    return sequelize.define('TradingHistoryPreviousOtherOfficer', {
        creditReportID: {
        ...
        schema: 'public',
        tableName: 'TradingHistoryPreviousOtherOfficers',
        timestamps: false
    });
};
...
module.exports.initRelations = function() {
    ...
    TradingHistoryPreviousOtherOfficer.belongsTo(CreditReport, {
        as: 'CreditReport',
