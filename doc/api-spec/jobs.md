...
Lists the job types for an application container and application status type
...
Lists the job types for an application container
...
### `/jobs/:id/:astid/rollback`

Lists the rollback job types for an application container and application status type
